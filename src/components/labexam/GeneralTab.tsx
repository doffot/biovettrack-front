      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <input
            ...
            className={`w-full px-3 py-2 rounded-lg border text-sm transition-all
              ${errors.date 
                ...
                : 'border-gray-200 bg-white hover:border-vet-primary/50 focus:border-vet-primary focus:ring-vet-primary/20'
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-lg border border-gray-200 bg-white text-sm transition-all
          ...
          {hemogramFields.map((field) => {
            ...
            return (
              ...
              >
                ...
                <label className="block text-[10px] font-semibold text-gray-600 mb-1.5 truncate">
                  {field.label}
                </label>
