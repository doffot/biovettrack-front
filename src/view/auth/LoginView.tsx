        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 md:p-8">
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden mb-6 text-center">
              ...
              <p className="text-lg font-bold text-vet-accent drop-shadow-lg">
                Sistema Veterinario
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit(handleLogin)} className="space-y-4 md:space-y-5">
              ...
              <div>
                <div className="relative">
                  <div className="absolute left-3 md:left-4 top-1/2 -translate-y-1/2 flex items-center gap-2 md:gap-3 pointer-events-none">
                    <img
                      src="/vet_user.svg"
                      alt="User icon"
                      className="h-6 md:h-7 w-auto drop-shadow-2xl"
                    />
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className={`w-full pl-24 md:pl-28 pr-3 md:pr-4 py-3 md:py-3.5 text-sm md:text-base bg-transparent border rounded-xl text-white placeholder-transparent font-medium focus:outline-none transition-all
              ...
              <div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-36 md:pl-44 pr-10 md:pr-12 py-3 md:py-3.5 text-sm md:text-base bg-transparent border rounded-xl text-white placeholder-gray-300 font-medium focus:outline-none transition-all
                      autofill:bg-transparent autofill:text-white
                      autofill:shadow-[0_0_0_1000px_transparent_inset]
                      autofill:[-webkit-text-fill-color:white]
                      ${
                  ...
                  <button
                    ...
                    className="absolute top-1/2 -translate-y-1/2 right-3 md:right-4 flex items-center text-vet-muted hover:text-vet-accent transition-colors"
                  >
                    {showPassword ? (
