                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-3 sm:space-y-4 xl:space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 xl:gap-6 justify-center pt-4 sm:pt-6 xl:pt-8">
                      ...
                      <button
                        type="button"
                        className="group relative overflow-hidden rounded-xl sm:rounded-2xl xl:rounded-3xl border-2 bg-gradient-radial-center backdrop-blur-sm hover:shadow-premium-hover hover:scale-105 sm:hover:scale-110 transition-all duration-300 bg-muted/20 border-muted/30 px-4 py-2.5 sm:px-6 sm:py-3 xl:px-8 xl:py-4"
                        title="Próximamente disponible"
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-muted/10 to-transparent animate-shimmer" />
                        <div className="relative z-10 flex items-center justify-center gap-2 xl:gap-3">
                          <TestTube className="w-4 h-4 sm:w-5 sm:h-5 xl:w-6 xl:h-6 text-muted" />
                          <span className="text-muted font-bold text-sm sm:text-sm xl:text-base">Hematología</span>
                        </div>
                      </button>
                    </div>
                  </div>
