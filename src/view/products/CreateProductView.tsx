      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-5xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate(-1)}
              className="p-2 rounded-lg hover:bg-gray-100 text-vet-muted transition-colors"
            >
              <ArrowLeft className="w-5 h-5" />
            </button>
            <h1 className="text-xl font-bold text-vet-text">Nuevo Producto</h1>
          </div>
        </div>
      </header>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              step="0.01"
                              placeholder="0.00"
                              className="w-full pl-7 pr-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-vet-primary/20 focus:border-vet-primary"
                            />
                          </div>
                        </div>
                      ...
                      <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                        <label className="flex items-start gap-3 cursor-pointer">
                          <input
                            ...
                            onChange={handleChange}
                            className="mt-0.5 w-4 h-4 text-vet-primary border-gray-300 rounded focus:ring-vet-primary"
                          />
                            ...
                            <div>
                              ...
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  step="0.01"
                                  placeholder="0.00"
                                  className="w-full pl-7 pr-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-vet-primary/20 focus:border-vet-primary bg-white"
                                />
                              </div>
                            </div>
                          </div>
                      ...
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input
                          ...
                          onChange={handleChange}
                          className="w-4 h-4 text-vet-primary border-gray-300 rounded focus:ring-vet-primary"
                        />
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3">
              <button
                type="button"
                onClick={() => navigate(-1)}
                className="px-4 py-2 text-sm text-gray-600 font-medium rounded-lg border border-gray-200 hover:bg-gray-100 transition-colors"
              >
                Cancelar
              </button>
              <button
